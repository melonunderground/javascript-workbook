...
//get even numbers in new nums array with filter
const getEvens = nums.filter((num) => {
  return num % 2 === 0;
})

// add evens from getEvens with reduce
const sumEvens = getEvens.reduce((total, num) => {
  return total + num;
});
...
const atxIdx = (element, index) => {
  return (element + index == 512);
};
console.log(nums.findIndex(atxIdx))
console.log(nums[505])
